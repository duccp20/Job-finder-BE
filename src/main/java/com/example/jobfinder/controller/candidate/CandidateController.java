...
public class CandidateController {
    ...
    public ResponseEntity<?> update(
        ...
        try {
            ...
            CandidateProfileDTO candidateProfileDTO =
                    jsonReaderService.readValue(candidateProfileDTOJson, CandidateProfileDTO.class);
    ...
    public ResponseEntity<?> updateImage(
            @PathVariable long id, @RequestPart(name = "fileAvatar", required = false) MultipartFile fileAvatar)
            throws IOException {
        try {
            if (!candidateService.isCurrentAuthor(id)) {
                throw new AccessDeniedException();

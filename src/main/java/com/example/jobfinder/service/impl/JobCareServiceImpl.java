...
public class JobCareServiceImpl implements JobCareService {
    ...
    public static final int ActiveStatic = 1;
    ...
    public List<Integer> findJobSaveOfCandidateID() {
        ...
        List<Integer> listJobId =
                this.jobCareRepository.finJobSave(candidate.get().getId());
        if (listJobId.isEmpty()) return null;
    ...
    public List<JobCareDTO> findAll() {
        ...
        return this.jobCareRepository.findAll().stream()
                .map(item -> this.jobCareMapper.toDTO(item))
    ...
    public JobCareDTO findById(int id) {
        ...
        return this.jobCareMapper.toDTO(this.jobCareRepository
                .findById((long) id)
    ...
    public ApiResponse create(long idJob) {
        ...
        if (jobDTO.getStatusDTO().getStatusId() != ActiveStatic) throw new IllegalArgumentException();
